...
{
    /**
     * @Route("/", name="professeurs_index", methods={"GET"})
     */
    ...
    /**
     * @Route("/new", name="professeurs_new", methods={"GET", "POST"})
     */
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('professeurs_index', [], Response::HTTP_SEE_OTHER);
        }
    ...
    /**
     * @Route("/{id}", name="professeurs_show", methods={"GET"})
     */
    ...
    /**
     * @Route("/{id}/edit", name="professeurs_edit", methods={"GET", "POST"})
     */
    ...
    /**
     * @Route("/{id}", name="professeurs_delete", methods={"POST"})
     */
